  ...
  const projects = [
    {
      title: "Personal Page",
      description:
        "Este mismo sitio — construido con Svelte 5, efectos CSS avanzados y animaciones fluidas.",
    ...
    },
    {
      ...
      description:
        "Panel analítico que integra modelos LLM para análisis de datos en tiempo real.",
    ...
    },
    {
      ...
      description:
        "Arquitectura distribuida con alta disponibilidad, observabilidad y deploys automáticos.",
    ...
    },
    {
      ...
      description:
        "Herramienta de colaboración en tiempo real con WebSockets, OT y conflict resolution.",
...
<section id="hero" class="hero">
  ...
  <div class="hero-content">
    ...
    <p class="hero-subtitle fade-in">
      ...
      +13 años transformando ingeniería en impacto real — desde la banca hasta la
      IA generativa.
    </p>
    <div class="hero-actions fade-in">
      ...
      <a
        href="mailto:carlos.developer1983@gmail.com"
        class="btn-secondary magnetic">Hablemos</a
      >
    ...
    <div class="hero-stats fade-in">
      ...
      <div class="stat">
        <span class="stat-number">2</span><span class="stat-label"
          >Continentes impactados</span
        >
      </div>
      <div class="stat-divider"></div>
      <div class="stat">
        <span class="stat-number">∞</span><span class="stat-label"
          >Bugs detectados antes</span
        >
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="about-grid">
      ...
      <div class="about-text fade-in">
        ...
        <h2>
          Tech Lead en la intersección de <span class="gradient-text"
            >Calidad e IA</span
          >
        </h2>
        <p>
          Soy Tech Lead y Arquitecto de Software con +13 años de experiencia en
          el ciclo completo del software (SDLC), especializado en la
          intersección entre <strong>Ingeniería de Calidad</strong>,
          <strong>Automatización</strong>
          e <strong>Inteligencia Artificial Generativa</strong>.
        </p>
        <p>
          He liderado modernizaciones de ecosistemas legado —incluyendo
          migraciones de <strong>COBOL a tecnologías modernas</strong>— y el
          diseño de <strong>Agentes IA aplicados a calidad</strong> en grandes corporaciones
          bancarias como BBVA, con impacto directo en equipos de Europa y LATAM.
        </p>
        <p>
          Mi diferencial: entiendo el problema de calidad <strong
            >desde la arquitectura</strong
          >, no solo desde el testing. Combino base técnica sólida con capacidad
          real de liderazgo, mentoring y traducción de necesidades de negocio en
        ...
        <div class="about-links">
          ...
          <a
            href="https://github.com/munchkin09"
            target="_blank"
            rel="noopener"
            class="about-link"
          >
          ...
          <a
            href="https://linkedin.com/in/carlosledesmac"
            target="_blank"
            rel="noopener"
            class="about-link"
          >
...
<section id="strengths" class="strengths">
  <div class="container">
    <div class="section-header fade-in">
      ...
      <p class="section-sub">
        No solo escribo código. Construyo sistemas, lidero equipos y genero
        impacto.
      </p>
    </div>
...
<section id="skills" class="skills-section">
  <div class="container">
    <div class="section-header fade-in">
      ...
      <p class="section-sub">
        Hover cada porción para ver el detalle de cada tecnología.
      </p>
    </div>
...
<section id="experience" class="experience-section">
  <div class="container">
    <div class="section-header fade-in">
      ...
      <p class="section-sub">
        De la ingeniería clásica a los agentes IA, pasando por banca, IoT y
        consultoría.
      </p>
    </div>
    <div class="timeline">
...
<section id="blog" class="blog-section">
  <div class="container">
    <div class="section-header fade-in">
      ...
      <p class="section-sub">
        Ideas, reflexiones y aprendizajes del día a día. Publicado desde
        Telegram.
      </p>
    </div>
...
<section id="contact" class="contact-section">
  <div class="container">
    <div class="contact-inner fade-in">
      ...
      <h2>
        Hablemos de tu <span class="gradient-text">próximo proyecto</span>
      </h2>
      <p class="contact-sub">
        Siempre abierto a nuevos retos, colaboraciones y conversaciones
        interesantes. Ya sea un proyecto completo, una consultoría puntual o
        simplemente una charla técnica.
      </p>
      <a
        href="mailto:carlos.developer1983@gmail.com"
        class="btn-primary magnetic contact-btn"
      >
        <svg
          width="20"
          height="20"
      ...
      <div class="contact-socials">
        ...
        <span class="social-sep">·</span>
        <a
          href="https://twitter.com/carloslc"
          target="_blank"
          rel="noopener"
...
<footer>
  <p>
    © 2026 Carlos Ledesma · Hecho con <span class="heart">♥</span> y
